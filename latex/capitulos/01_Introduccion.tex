...
\boldparagraph{Interoperabilidad de salida}{
    Entrega de la información en formatos compatibles con los sistemas de Historia Clínica Electrónica (\englishText{HCE}), facilitando el intercambio de datos entre niveles asistenciales.
}
...
\begin{itemize}
    ...
    \item Lograr que al menos el 80\,\% de los informes generados sean aceptados por el personal médico 
