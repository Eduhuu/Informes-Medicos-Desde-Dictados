...
\input{tablas/anexo1/diagrama_gantt.tex}

\section{Sostenibilidad y mantenimiento}\label{section:gestion_sostenibilidad}


La arquitectura modular basada en el patrón de diseño \englishText{Factory} y configuración externa (\texttt{config.yaml}) facilita
