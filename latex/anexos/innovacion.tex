...
Facilidad de la generación de informes clínicos a partir del dictado médico, reduciendo el tiempo
...
\begin{itemize}
    ...
    clínicas más allá del conjunto evaluado, y, si el caso de uso lo justifica, inicio del proceso de
    certificación como producto sanitario (Sección~\ref{section:innovacion_legal}).
\end{itemize}
