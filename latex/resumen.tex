...
integral orientado a la automatización de la documentación médica mediante la 
...
\begin{enumerate}
    ...
    \item \textbf{Generación de informes mediante \englishText{LLMs}:} 
        Síntesis de información utilizando modelos de lenguaje de gran escala, 
        incorporando mecanismos de verificación para asegurar la fidelidad clínica.
    \item \textbf{Salida estructurada e interoperable:} 
        ...
        generación de informes clínicos normalizados.
\end{enumerate}
...
La viabilidad de la propuesta se demuestra mediante una validación con especialistas 
del sector y una evaluación cuantitativa basada en métricas de precisión técnica 
