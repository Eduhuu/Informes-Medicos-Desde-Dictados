...
\newcommand{\tituloTFM}{
    Generación automática de informes clínicos a partir de dictado médico usando PLN y ASR
}
\newcommand{\subtituloTFM}{
    Extracción de entidades clínicas, generación de informes clínicos 
    utilizando LLMs con salida y estructura estructurada (FHIR)
}
...
\newcommand{\titleMT}{Automatic generation of clinical reports from medical dictation using PLN and ASR}
\newcommand{\subtitleMT}{Extraction of clinical entities, generation of clinical reports using LLMs with structured output (FHIR)}
