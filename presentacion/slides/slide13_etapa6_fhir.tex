...
\begin{frame}[plain]
  \begin{tikzpicture}[remember picture, overlay]
    ...
    \node[anchor=north west]
      ...
      {\Large\bfseries\sffamily\color{accentTeal}Bundle válido \normalfont\normalsize\sffamily\color{inkText}(4\,/\,5)};
    \node[anchor=north west]
      ...
      {\parbox[t]{5.1cm}{\raggedright\fontsize{7.5}{9.2}\selectfont\sffamily\color{inkText}%
       El \textit{Bundle} de este caso supera la validación estructural: \texttt{resourceType},
       referencias \texttt{subject} y \texttt{meta.profile} correctos.\\[4pt]
       Es, junto a \textit{ASR} y \textit{NER}, la dimensión mejor puntuada del caso ---muy por
       encima de \textit{Terminología} e \textit{Informe} (2\,/\,5 ambas).}};
